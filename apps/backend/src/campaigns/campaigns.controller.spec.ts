...
describe('CampaignsController', () => {
  ...
  describe('getRecipientStats', () => {
    it('usa i valori di default quando page/pageSize non sono forniti', async () => {
      ...
      expect(mockService.getRecipientStats).toHaveBeenCalledWith('uuid-1', 1, 50, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
    });
    ...
    it('accetta valori validi e li inoltra al servizio', async () => {
      ...
      expect(mockService.getRecipientStats).toHaveBeenCalledWith('uuid-1', 2, 25, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
    });

    it('inoltra il parametro search al servizio', async () => {
      await controller.getRecipientStats('uuid-1', '1', '50', 'rossi');
      expect(mockService.getRecipientStats).toHaveBeenCalledWith('uuid-1', 1, 50, 'rossi', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
    });
    ...
    it('inoltra i parametri status e deliveryStatus al servizio', async () => {
      ...
      expect(mockService.getRecipientStats).toHaveBeenCalledWith('uuid-1', 1, 50, undefined, 'failed', 'ACCEPTED', undefined, undefined, undefined, undefined, undefined, undefined);
    });
    ...
    it('splitta il parametro tags (comma-separated) in un array al servizio', async () => {
      ...
      expect(mockService.getRecipientStats).toHaveBeenCalledWith('uuid-1', 1, 50, undefined, undefined, undefined, ['diverted', 'appio'], 'yes', undefined, undefined, undefined, undefined);
    });
    ...
    it('inoltra il parametro postalDeliveryStatus al servizio', async () => {
      ...
      expect(mockService.getRecipientStats).toHaveBeenCalledWith('uuid-1', 1, 50, undefined, undefined, undefined, undefined, undefined, 'CONSEGNATO', undefined, undefined, undefined);
    });
  });
