...
import { CreateSignatureVerificationJobs1787200000000 } from './migrations/1787200000000-CreateSignatureVerificationJobs.js';
import { SignatureVerificationJob } from '../entities/signature-verification-job.entity.js';
import { AddCampaignGroupId1787300000000 } from './migrations/1787300000000-AddCampaignGroupId.js';
import { AddEnrichmentWarningDismissal1789557778610 } from './migrations/1789557778610-AddEnrichmentWarningDismissal.js';
import { AddMissingPaymentSplitToEnrichmentJobs1789600000000 } from './migrations/1789600000000-AddMissingPaymentSplitToEnrichmentJobs.js';
import { AddPendingReviewStatus1789700000000 } from './migrations/1789700000000-AddPendingReviewStatus.js';
import { AddDownloadEventsRecipientIdIndex1789800000000 } from './migrations/1789800000000-AddDownloadEventsRecipientIdIndex.js';
import { RemoveInipecSettings1790000000000 } from './migrations/1790000000000-RemoveInipecSettings.js';
...
import { AddPostalPosteTrackingOutcomeAt1790200000000 } from './migrations/1790200000000-AddPostalPosteTrackingOutcomeAt.js';
import { AddPostalPosteTrackingUntil1790300000000 } from './migrations/1790300000000-AddPostalPosteTrackingUntil.js';
import { ReverifyPosteDelivered1790400000000 } from './migrations/1790400000000-ReverifyPosteDelivered.js';
  ...
  imports: [
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (config: ConfigService<AppConfiguration, true>) => ({
        ...
        entities: [Campaign, Recipient, NotificationAttempt, AppSetting, MailServerConfig, IoServiceConfig, Template, DownloadEvent, AuditLog, PostalProviderConfig, DomicileVerificationJob, EnrichmentJob, EnrichmentAddressOverride, OperatorDirectoryEntry, CampaignBulkRetryJob, ExternalApiClient, PostalAuthorizedUser, AgidTrustListCache, SignatureVerificationJob, PostalPosteTracking],
